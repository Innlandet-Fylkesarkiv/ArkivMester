...
class TestViewTest {
    ...
    private Color primaryColor = new Color(8, 83, 148);
    ...
    void createAndShowGUI() {
        Container ctnMock = mainView.getContainer();
        assertNotNull(ctnMock, "Main container is empty");

        testView.createAndShowGUI(ctnMock);
